...
///////////////////////////////////////////////////////////////////////////////
void BlockCollection::fillBlockData(glm::u64vec3 ijk, const float *in_data, float *out_blockData)
{
    size_t imageIdx = 0;
...
//            b.texture().textureUnit(0);
    ...
    delete [] image;
    gl_log("%d/%d blocks marked empty.", m_blocks.size()-m_nonEmptyBlocks.size(), m_blocks.size());
