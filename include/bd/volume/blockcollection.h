...
public:
    ...
    void filterBlocks(const float *data, unsigned int sampler, float tmin = 0.0f, float tmax = 1.0f);
...
private:
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void fillBlockData(glm::u64vec3 ijk, const float *in_data, float *out_blockData);
